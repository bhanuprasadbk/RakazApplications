...
module.exports = {
    ...
    //get customer mapped to sensorGroup
    getCustomerMappedToSensors: (sensorType, callback) => {
        const query = `            
SELECT sgm.id,sgm.sensor_type,sgm.sensor_group,sgm.customer_id,c.customer_name,sgm.device_id,d.deviceName FROM tbl_sensor_group_mapping sgm
JOIN tbl_customers c ON sgm.customer_id = c.id
